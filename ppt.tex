...
\author{Gengzhan \and Forest \and Juntao}
...
\begin{frame}[shrink=5]{Ablation: Four Conditions, Five Architectures}

{\footnotesize
\begin{tabular}{@{}ll@{\quad}ll@{}}
  \textbf{C0} & Raw UCI HAR, no adaptation &
  \textbf{C2} & C1 + Test-Time Batch Norm (TTBN) \\
  \textbf{C1} & UCI HAR + PhysicalDistortion &
