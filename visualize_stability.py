...
def main():
    ...
    parser.add_argument("--out-dir",     type=Path, default=Path("results_final/figures"))
    parser.add_argument("--ckpt-dir",    type=Path, default=Path("results_final/viz_checkpoints"))
    parser.add_argument("--hp-config",   type=Path, default=Path("results/hp_best_configs.json"))
